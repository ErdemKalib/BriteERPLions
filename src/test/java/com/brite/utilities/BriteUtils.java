...
public class BriteUtils {
    ...
    //private static String loaderMaskLocator = "//div[text()='Loading']";
    private static String loaderMaskLocator = "o_loading]"; // class

    //private static String pageSubTitleLocator = "h1[class='oro-subtitle']";
    //private static String pageSubTitleLocator = "o_thread_title";
   // private static String pageSubTitleLocator = "//ol//li[@class='active']";
    private static String pageSubTitleLocator = "ol >li[class='active']";
...
//        driver.findElement(By.xpath(tabLocator)).click();
    ...
    public static void waitUntilLoaderScreenDisappear(WebDriver driver){
        try {
            ...
            wait.until((ExpectedConditions.invisibilityOf((driver.findElement(By.className(loaderMaskLocator))))));
        } catch (Exception e){
            System.out.println(e + " : Loading mask is not present");
        }
    }
    ...
    public static void waitUntilLoaderScreenDisappear(){
        try {
            ...
            wait.until((ExpectedConditions.invisibilityOf((Driver.getDriver().findElement(By.className(loaderMaskLocator))))));
        } catch (Exception e){
            System.out.println(e + " : Loading mask is not present");
        }
    }
    ...
    /*
    returns page name , for example : #Inbox
     */
    public static String getPageSubTitle(){
        BriteUtils.waitUntilLoaderScreenDisappear(Driver.getDriver());
